...
/***/ function(module, exports, __webpack_require__) {
	...
	var _muicssReact = __webpack_require__(161);
	
	var _picResults = __webpack_require__(188);
	
	var _picResults2 = _interopRequireDefault(_picResults);
	
	var _PicView = __webpack_require__(189);
	
	var _PicView2 = _interopRequireDefault(_PicView);
	...
	var App = (function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function handleUpdate(value) {
	      this.setState({
	        picRequest: _extends({}, this.state.picRequest, {
	          tags: value
	        })
	      });
	    }
	    ...
	    key: 'handlePicView',
	    value: function handlePicView(pic) {
	      console.log('picView', pic);
	      this.setState({
	        picView: _extends({}, this.state.picView, {
	          pic: pic
	        }),
	        toggleView: 1
	      });
	    ...
	    key: 'handleSearchView',
	    value: function handleSearchView(pic) {
	      console.log('picView', pic);
	      this.setState({
	        toggleView: 0
	      });
	    ...
	    value: function handleSearchSubmit(e) {
	      ...
	      e.preventDefault();
	      var picRequest = this.state.picRequest;
	
	      var fetchResult = fetch('https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=3cfc5214b8dce09b084ad6ba57799de2&user_id=24662369@N07&tags=' + picRequest.tags + '&per_page=12&sort=relevance&format=json&nojsoncallback=1').then(function (response) {
	        console.log('response', response);
	        return response.json();
	      }).then(function (body) {
	        console.log('success', body.photos.photo);
	        var resultStatus = body.photos.photo.length ? true : false;
	        _this.setState({
	    ...
	    value: function render() {
	      ...
	      var picRequest = _state.picRequest;
	      var picResults = _state.picResults;
	      var picView = _state.picView;
	      var toggleView = _state.toggleView;
	      var resultStatus = _state.resultStatus;
	      ...
	      if (toggleView) {
	        contents = _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'a',
	            { onClick: function (e) {
	                return _this2.handleSearchView(e);
	              }, style: { fontSize: '16px', display: 'block', textAlign: 'center' } },
	            'Return to results'
	          ),
	          _react2['default'].createElement(_PicView2['default'], { pic: picView })
	        );
	      } else {
	        if (resultStatus) {
	          contents = _react2['default'].createElement(_picResults2['default'], { picResults: picResults, handlePicView: this.handlePicView });
	        } else {
	          contents = _react2['default'].createElement(
	            'h3',
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          _muicssReact.Container,
	          { style: { maxWidth: '600px', marginTop: '30px' } },
	          _react2['default'].createElement(
	            _muicssReact.Panel,
	            { style: { background: 'rgba(255, 255, 255, .1)', border: 'solid 2px #2196F3' } },
	            _react2['default'].createElement(
	              'div',
	              {
	              ...
	              _react2['default'].createElement(
	                _muicssReact.Form,
	                null,
	                _react2['default'].createElement(_muicssReact.Input, { type: 'text',
	                  ...
	                  onChange: function (e) {
	                    return _this2.handleUpdate(e.target.value);
	                  }
	                }),
	                _react2['default'].createElement(
	                  _muicssReact.Button,
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** Define module API */
	module.exports = {
	  Appbar: __webpack_require__(162),
	  Button: __webpack_require__(164),
	  Caret: __webpack_require__(168),
	  Checkbox: __webpack_require__(169),
	  Col: __webpack_require__(171),
	  Container: __webpack_require__(172),
	  Divider: __webpack_require__(173),
	  Dropdown: __webpack_require__(174),
	  DropdownItem: __webpack_require__(175),
	  Form: __webpack_require__(176),
	  Input: __webpack_require__(177),
	  Option: __webpack_require__(179),
	  Panel: __webpack_require__(181),
	  Radio: __webpack_require__(182),
	  Row: __webpack_require__(183),
	  Select: __webpack_require__(184),
	  Tab: __webpack_require__(185),
	  Tabs: __webpack_require__(186),
	  Textarea: __webpack_require__(187)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var babelHelpers = __webpack_require__(163);
	/**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jqLite = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var config = __webpack_require__(167),
	    jqLite = __webpack_require__(165),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _caret = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PicResults = function PicResults(props) {
	  var picResults = props.picResults;
	  var handlePicView = props.handlePicView;
	    ...
	    _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          _muicssReact.Row,
	          { style: { display: 'block' } },
	          picResults.map(function (pic, i) {
	            return _react2['default'].createElement(
	              _muicssReact.Col,
	              { lg: '4', md: '6', sm: '12', xs: '12', key: i, style: { height: '400px', marginBottem: '10px' } },
	              _react2['default'].createElement(
	                _muicssReact.Panel,
	                {
	                ...
	                _react2['default'].createElement(
	                  'div',
	                  { className: 'viewButton', style: { bottom: '10', width: '100%', height: '50px' } },
	                  _react2['default'].createElement(
	                    _muicssReact.Button,
	                    {
	                      variant: 'raised',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PicView = function PicView(props) {
	  var pic = props.pic;
	    ...
	    _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        _muicssReact.Panel,
	        {
	          ...
	          style: { backgroundColor: 'transparent', color: '#2196F3', textAlign: 'center', marginTop: '30px', fontSize: '30px' } },
	        'Please search and select a photograph to view.'
	      )
	    )
	  );
	};
	
	exports['default'] = PicView;
	module.exports = exports['default'];
